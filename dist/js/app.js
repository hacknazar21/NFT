    ...
    (() => {
        ...
        async function headerAnim() {
            ...
            if (window.screen.width > 1300) await setInterval((() => {
                ...
                img_header.setAttribute("y", `${convertRange(1, 2e3, 0, 10, i)}%`);
                border_collection.setAttribute("x1", `${convertRange(1, 2e3, -100, 100, i)}%`);
                border_collection.setAttribute("y1", `${convertRange(1, 2e3, -100, 100, i)}%`);
                border_collection.setAttribute("y2", `${convertRange(1, 2e3, -100, 100, i)}%`);
            }), 10); else if (window.screen.width < 1300 && window.screen.width > 767) {
                await setInterval((() => {
                    if (i > 2e3) {
                        flag = true;
                        i = 2e3;
