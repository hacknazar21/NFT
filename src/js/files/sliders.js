...
import Swiper, { Autoplay, Navigation, EffectFade, EffectCreative, Pagination } from 'swiper';
/*
...
function initSliders() {
	...
	if (document.querySelector('.main-slider-swiper')) { // Указываем скласс нужного слайдера
		// Создаем слайдер
